...
const REQUESTS: RequestSeed[] = [
  ...
  // ── Istoriniai APPROVED (skirtingiems mėn. trendams) ──
  {
    tenantCode: 'AAD',
    createdByUsername: 'aad-admin',
    status: 'APPROVED',
    ...
    systemCode: 'AADIS',
    projectType: 'Programinė įranga',
    description: 'Centrinio AADIS modulio metinė licencija.',
    plannedWorks: 'Licencijos atnaujinimas, palaikymo paslaugos.',
    priority: 1,
    ...
    decisionAmount: 28000,
    decisionSource: 'AM IT biudžetas 2025',
    decisionProtocol: 'AM-FIN-2025/045',
    decisionOrder: 'AM Įsakymas 2025/A-145',
    decisionByUsername: 'am-admin',
    ...
    comments: [
      { authorUsername: 'aad-admin', kind: 'submitted' },
      {
        authorUsername: 'am-admin',
        kind: 'approved',
        body: 'Licencijos kasmetinis atnaujinimas — patvirtinta pilnai.',
        metadata: { fromStatus: 'SUBMITTED', toStatus: 'APPROVED' },
      },
    ],
  },
  {
    ...
    systemCode: 'GELMES',
    projectType: 'IT integracija',
    description: 'Vykdoma integracija — Europinė geologijos duomenų bazė.',
    plannedWorks: 'Spec, integracinis serviso kūrimas, testavimas.',
    priority: 2,
    procurementStage: 'Užbaigta',
    costDevelopment: 42000,
    costAnalysis: 8000,
    fundingFromIt: 50000,
    q1: 20000,
    q2: 20000,
    ...
    implementationDeadline: '2025-09-30',
    decisionAmount: 50000,
    decisionSource: 'AM IT biudžetas 2025',
    decisionProtocol: 'AM-FIN-2025/052',
    decisionOrder: 'AM Įsakymas 2025/A-178',
    decisionByUsername: 'am-user',
    submittedDaysAgo: 180,
    decidedDaysAgo: 170,
    comments: [
      { authorUsername: 'lgt-admin', kind: 'submitted' },
      {
        authorUsername: 'am-user',
        kind: 'approved',
        body: 'Integracijos planas aiškus, biudžetas pagrįstas.',
        metadata: { fromStatus: 'SUBMITTED', toStatus: 'APPROVED' },
      },
    ],
  },
  {
    ...
    systemCode: 'GEOSTT',
    projectType: 'Mobilioji aplikacija',
    description: 'Saugomų teritorijų lankytojams skirtos programėlės plėtra.',
    plannedWorks: 'iOS + Android funkcionalumas, vertimai, push notifications.',
    priority: 2,
    procurementStage: 'Užbaigta',
    costDevelopment: 35000,
    costAnalysis: 5000,
    ...
    implementationDeadline: '2025-11-30',
    decisionAmount: 40000,
    decisionSource: 'AM IT biudžetas 2025',
    decisionProtocol: 'AM-FIN-2025/061',
    decisionOrder: 'AM Įsakymas 2025/A-189',
    decisionByUsername: 'am-admin',
  ...
  },
  {
    ...
    createdByUsername: 'aad-user',
    status: 'APPROVED',
    projectName: 'AADIS palaikymas Q1-Q2 2025',
    systemCode: 'AADIS',
    projectType: 'IT palaikymas',
    description: 'Sistemos palaikymo paslaugos pirmąjį pusmetį.',
    plannedWorks: 'Klaidų taisymas, performance tuning, dokumentacija.',
    priority: 1,
    ...
    executorName: 'Tomas Burba',
    executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2025-06-30',
    decisionAmount: 18000,
    decisionSource: 'AM IT biudžetas 2025',
    decisionProtocol: 'AM-FIN-2025/070',
    decisionOrder: 'AM Įsakymas 2025/A-198',
    decisionByUsername: 'am-user',
    submittedDaysAgo: 100,
    decidedDaysAgo: 92,
    comments: [
      { authorUsername: 'aad-user', kind: 'submitted' },
      {
        authorUsername: 'am-user',
        kind: 'approved',
        metadata: { fromStatus: 'SUBMITTED', toStatus: 'APPROVED' },
  ...
  },
  {
    ...
    systemCode: 'GELMES',
    projectType: 'UX projektas',
    description: 'Vartotojo sąsajos atnaujinimas pagal Lietuvos viešojo sektoriaus dizaino gaires.',
    plannedWorks: 'Research, prototipai, dizainas, implementacija.',
    priority: 3,
    procurementStage: 'Pradėtas',
    costAnalysis: 6000,
  ...
  },
  {
    ...
    systemCode: 'AADIS',
    projectType: 'IT infrastruktūra',
    description: 'Atsarginės kopijos ir DR procedūros AADIS sistemai.',
    plannedWorks: 'Audit, sprendimo pasirinkimas, įdiegimas, treniruotė.',
    priority: 1,
    procurementStage: 'Pradėtas',
    costAnalysis: 4000,
