...
const REQUESTS: RequestSeed[] = [
  ...
  // ── 2025-05/06 (~340-300 dienų atgal) ──
  {
    ...
    submittedDaysAgo: 340, decidedDaysAgo: 332,
  ...
  },
  {
    ...
    submittedDaysAgo: 335, decidedDaysAgo: 325,
    ...approved(28000, 2025, 'am-admin', 15),
    comments: approvedComments('aad-admin', 'am-admin', 'Licencijos kasmetinis atnaujinimas — patvirtinta pilnai.'),
  },
  ...
  // ── 2025-07 (~305-280 dienų) ──
  {
    ...
    submittedDaysAgo: 305, decidedDaysAgo: 298,
  ...
  },
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Tomas Burba', executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2025-12-31',
    submittedDaysAgo: 300, decidedDaysAgo: 290,
  ...
  // ── 2025-08 (~275-260 dienų) ──
  {
    ...
    implementationDeadline: '2025-12-31',
    submittedDaysAgo: 275, decidedDaysAgo: 268,
  ...
  },
  {
    ...
    submittedDaysAgo: 270, decidedDaysAgo: 260,
    ...approved(35000, 2025, 'am-admin', 31),
    comments: approvedComments('aad-admin', 'am-admin', 'Integracija svarbi tarpžinybiniam darbui.'),
  },
  {
    ...
    submittedDaysAgo: 268, decidedDaysAgo: 255,
  ...
  // ── 2025-09 (~245-230 dienų) — peak season ──
  {
    ...
    implementationDeadline: '2026-03-31',
    submittedDaysAgo: 245, decidedDaysAgo: 236,
  ...
  },
  {
    ...
    responsibleInstitution: 'LGT', executorName: 'Rasa Janušienė', executorEmail: 'rasa.janusiene@lgt.lt',
    implementationDeadline: '2026-06-30',
    submittedDaysAgo: 240, decidedDaysAgo: 230,
    ...approved(50000, 2025, 'am-admin', 38),
    comments: approvedComments('lgt-admin', 'am-admin', 'Portalas atveria duomenis mokslo bendruomenei — patvirtinta visa apimtimi.'),
  },
  ...
  // ── 2025-10 (~220-200 dienų) ──
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Tomas Burba', executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2026-06-30',
    submittedDaysAgo: 220, decidedDaysAgo: 210,
  ...
  },
  {
    ...
    submittedDaysAgo: 215, decidedDaysAgo: 205,
  ...
  },
  {
    ...
    responsibleInstitution: 'VSTT', executorName: 'Aušra Petrulienė', executorEmail: 'ausra.petruliene@vstt.lt',
    implementationDeadline: '2025-12-31',
    submittedDaysAgo: 210, decidedDaysAgo: 200,
  ...
  // ── 2025-11 (~185-170 dienų) ──
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Mantas Daunoras', executorEmail: 'mantas.daunoras@aad.lt',
    implementationDeadline: '2025-12-31',
    submittedDaysAgo: 185, decidedDaysAgo: 178,
  ...
  },
  {
    ...
    submittedDaysAgo: 180, decidedDaysAgo: 170,
  ...
  },
  {
    ...
    responsibleInstitution: 'LGT', executorName: 'Vilma Klimaitė', executorEmail: 'vilma.klimaite@lgt.lt',
    implementationDeadline: '2026-04-30',
    submittedDaysAgo: 175, decidedDaysAgo: 165,
    decisionByUsername: 'am-user',
    comments: rejectedComments(
      'lgt-user',
      'am-user',
  ...
  },
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Tomas Burba', executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2026-03-31',
    submittedDaysAgo: 170, decidedDaysAgo: 160,
  ...
  // ── 2025-12 (~155-145 dienų) ──
  {
    ...
    responsibleInstitution: 'LGT', executorName: 'Rasa Janušienė', executorEmail: 'rasa.janusiene@lgt.lt',
    implementationDeadline: '2026-06-30',
    submittedDaysAgo: 155, decidedDaysAgo: 145,
  ...
  },
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Mantas Daunoras', executorEmail: 'mantas.daunoras@aad.lt',
    implementationDeadline: '2026-04-30',
    submittedDaysAgo: 145, decidedDaysAgo: 137,
  ...
  // ── 2026-01 (~140-105 dienų) ──
  {
    ...
    submittedDaysAgo: 140, decidedDaysAgo: 130,
  ...
  },
  {
    ...
    responsibleInstitution: 'LGT', executorName: 'Rasa Janušienė', executorEmail: 'rasa.janusiene@lgt.lt',
    implementationDeadline: '2026-02-28',
    submittedDaysAgo: 125, decidedDaysAgo: 115,
  ...
  },
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Tomas Burba', executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2025-12-31',
    submittedDaysAgo: 105, decidedDaysAgo: 95,
  ...
  // ── 2026-02 (~100-75 dienų) ──
  {
    ...
    responsibleInstitution: 'VSTT', executorName: 'Jonas Vaitkus', executorEmail: 'jonas.vaitkus@vstt.lt',
    implementationDeadline: '2026-09-30',
    submittedDaysAgo: 100, decidedDaysAgo: 90,
  ...
  },
  {
    ...
    submittedDaysAgo: 95, decidedDaysAgo: 85,
  ...
  },
  {
    ...
    submittedDaysAgo: 80, decidedDaysAgo: 72,
  ...
  },
  {
    ...
    responsibleInstitution: 'VSTT', executorName: 'Aušra Petrulienė', executorEmail: 'ausra.petruliene@vstt.lt',
    implementationDeadline: '2026-08-31',
    submittedDaysAgo: 75, decidedDaysAgo: 65,
  ...
  // ── 2026-03 (~55-45 dienų) ──
  {
    ...
    submittedDaysAgo: 55, decidedDaysAgo: 45,
  ...
  },
  {
    ...
    submittedDaysAgo: 50, decidedDaysAgo: 38,
    decisionByUsername: 'am-admin',
    comments: rejectedComments(
      'lgt-admin',
      'am-admin',
  ...
  },
  {
    ...
    submittedDaysAgo: 45, decidedDaysAgo: 35,
    ...approved(12000, 2026, 'am-admin', 28),
    comments: approvedComments('am-admin', 'am-admin', 'AM administratorius suformulavo prašymą už AAD — patvirtinta po peržiūros.'),
  },
  ...
  },
  {
    ...
    implementationDeadline: '2026-12-31',
    submittedDaysAgo: 5,
    comments: [{ authorUsername: 'am-admin', kind: 'submitted', body: 'Sukurta AM administratoriaus pavedimu — LGT vadovas patvirtino prioritetus.' }],
  },
  ...
  },
  {
    ...
    responsibleInstitution: 'LGT', executorName: 'Rasa Janušienė', executorEmail: 'rasa.janusiene@lgt.lt',
    implementationDeadline: '2026-12-31',
    submittedDaysAgo: 20, decidedDaysAgo: 14,
    decisionByUsername: 'am-user',
    comments: returnedComments(
      'lgt-admin',
      'am-user',
  ...
  },
  {
    ...
    responsibleInstitution: 'AAD', executorName: 'Tomas Burba', executorEmail: 'tomas.burba@aad.lt',
    implementationDeadline: '2026-12-31',
    submittedDaysAgo: 6, decidedDaysAgo: 3,
    decisionByUsername: 'am-user',
    comments: returnedComments(
      'aad-user',
      'am-user',
