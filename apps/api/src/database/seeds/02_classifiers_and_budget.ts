...
const GROUPS: GroupSeed[] = [
  ...
  },
  {
    ...
    description: 'IS sąrašas paraiškos formoje. Sutampa su seed demo prašymais.',
    items: [
      { code: 'AADIS', name: 'AADIS — Aplinkos apsaugos departamento IS', sortOrder: 1 },
      { code: 'GELMES', name: 'GELMES — Žemės gelmių informacinė sistema (LGT)', sortOrder: 2 },
      { code: 'GEOSTT', name: 'GEOSTT — Saugomų teritorijų geoportalas (VSTT)', sortOrder: 3 },
      { code: 'GPAIS', name: 'GPAIS — Gaminių paskirstymo IS', sortOrder: 4 },
      { code: 'BIIP', name: 'BIIP — Biologinės įvairovės info platforma', sortOrder: 5 },
      { code: 'DBSIS', name: 'DBSIS — Dokumentų valdymo sistema', sortOrder: 6 },
      { code: 'MEDZIOKLE', name: 'Medžioklės IS', sortOrder: 7 },
      { code: 'AAA', name: 'AAA — Aplinkos apsaugos agentūros IS', sortOrder: 8 },
      { code: 'OTHER', name: 'Kita', sortOrder: 99 },
    ],
  },
  {
    code: 'project_type',
    name: 'Projekto tipai',
    description: 'Projekto tipas paraiškos formoje. Atspindi realius AM IT projektus.',
    items: [
      { code: 'IT_SYSTEM', name: 'IT sistema', sortOrder: 1 },
      { code: 'IT_SUPPORT', name: 'IT palaikymas', sortOrder: 2 },
      { code: 'IT_INTEGRATION', name: 'IT integracija', sortOrder: 3 },
      { code: 'SOFTWARE', name: 'Programinė įranga', sortOrder: 4 },
      { code: 'MODERNIZATION', name: 'Modernizavimas', sortOrder: 5 },
      { code: 'RESEARCH', name: 'Mokslinis projektas / tyrimas', sortOrder: 6 },
      { code: 'TRAINING', name: 'Mokymai', sortOrder: 7 },
      { code: 'DOCUMENTATION', name: 'Dokumentacija', sortOrder: 8 },
      { code: 'NEW_DEVELOPMENT', name: 'Naujas kūrimas', sortOrder: 9 },
      { code: 'INFRASTRUCTURE', name: 'IT infrastruktūra', sortOrder: 10 },
      { code: 'OTHER', name: 'Kita', sortOrder: 99 },
    ],
  },
  {
